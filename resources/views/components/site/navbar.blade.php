...
<header data-site-navbar class="sticky top-0 z-50 transition-all duration-300 bg-white/60 backdrop-blur-md">
    <div class="container mx-auto px-4 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <nav class="hidden lg:flex items-center gap-1">
                    ...
                    @if (isset($item['children']))
                        <div class="relative group">
                            <button type="button" @class([
                                ...
                                {{ $item['name'] }}
                                <svg class="size-4 transition group-hover:rotate-180" viewBox="0 0 20 20" fill="none"
                                    aria-hidden="true">
                            ...
                            <div
                                ...
                                <div class="bg-white rounded-xl shadow-xl border-t-2 border-primary overflow-hidden">
                ...
                <a href="{{ $pathFor('kontak') }}" wire:navigate
                    class="ml-2 px-5 py-2 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:bg-primary-dark transition shadow-md shadow-primary/30">
                    Kontak
                </a>
            </nav>

            <button type="button" data-navbar-open class="lg:hidden p-2 rounded-md text-dark" aria-label="Buka menu">
    ...
    <div data-navbar-overlay class="hidden fixed inset-0 z-50 bg-dark/60 backdrop-blur-sm lg:hidden"></div>

    <aside data-navbar-drawer
        class="fixed inset-y-0 right-0 z-50 w-80 max-w-[90vw] translate-x-full bg-white shadow-2xl overflow-y-auto transition-transform duration-300 lg:hidden">
        ...
        <div class="p-3 flex flex-col gap-1">
            ...
            <a href="{{ $pathFor('kontak') }}" wire:navigate
                class="mt-3 text-center px-4 py-3 rounded-xl bg-primary text-primary-foreground font-medium">
                Kontak
            </a>
        </div>
    </aside>
